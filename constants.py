...
DL_MODELS = ['bidir_clstm','fcn', 'unet', 'fcn_crnn','unet3d']
S1_NUM_BANDS = 3
S2_NUM_BANDS = 10
GRID_SIZE = 64
MIN_TIMESTAMPS = 16
...
S1_BAND_MEANS = np.array([-11.411486013023465, -17.94899228790914, 1.1545230539916498])

S1_BAND_STDS = np.array([3.738300142932384, 5.034191069133747, 11.114381405098202])
